# applempeg2_tool
This tool will convert any video file to perfectly encoded mpeg-2 at a reasonable quality with appropriate bitrate in the .mov container with the correct headers for Quicktime 7.7 and below.
